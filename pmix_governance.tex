...
after the two-week review period deadline before a quarterly meeting 
before a first vote or after having passed a first
vote. Revision Exception votes can be called by the proposer to evaluate 
...
if all members of the ASC eligible to vote and in attendance at a quarterly
meeting vote affirmatively for a Revision Exception vote, then the regular vote 
for the PR can proceed for the text of the PR including the modifications. 
If any member of the ASC eligible to vote votes negatively for the Revision
Exception vote, the proposer must chose to re-read the PR with the modifications
